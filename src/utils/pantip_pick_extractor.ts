...
export async function getPantipPicks() {
  try {
    ...
    const highlights: { title: string; subtitle: string; date: string; link: string; imageUrl: string }[] = [
      {
        title: 'ชวนแชร์เรื่องราวประทับใจ',
        subtitle: '',
        date: '2024-08-01',
      ...
      {
        title: '🚩 กิจกรรมแชร์ “หนัง/ละคร/ซีรีส์ ',
        subtitle: '',
        date: '2024-08-15',
      ...
      {
        title: '📌 พี่แป้งชวนรีวิว “มอยส์ตัวตึง.. 🌵',
        subtitle: '',
        date: '2024-07-25',
      ...
      {
        title: 'ชวนร่วมกิจกรรม บันทึกทริปกับ”',
        subtitle: '',
        date: '2024-08-17',
      ...
      {
        title: 'พันทิปนานุกรม … ชวนมาดู Cover ',
        subtitle: '',
        date: '2023-09-10',
